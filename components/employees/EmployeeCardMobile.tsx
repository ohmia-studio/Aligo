      ...
      >
        <div className="flex items-center gap-3">
          <input
            ...
            onChange={onToggle}
            className="h-4 w-4"
            aria-label={`Seleccionar contacto ${employee.nombre}`}
          />
        ...
        <div className="flex items-center gap-2">
          ...
          <motion.button
            ...
            aria-label={`${open ? 'Cerrar' : 'Abrir'} detalles de ${employee.nombre}`}
          >
            <ChevronDown />
          </motion.button>
        </div>
      ...
      >
        <div className="pt-2">
          <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
            ...
            <div className="text-accent truncate">{employee.email || '-'}</div>

            <div className="text-base-color/70 text-xs">DNI</div>
            <div className="text-accent truncate">{employee.dni || '-'}</div>
          </div>
        </div>
      </div>
    </div>

...
export const MAX_FILE_SIZE = .75 * 1024 * 1024 // 750kB
...
export const handleImageUpload = async (
  ...
  // Creamos URL local para preview en el editor
  const url = URL.createObjectURL(file);

  // Damos tiempo para la carga, y damos tiempo para cancelar la misma. 
  let progress = 0;
